// ======================================================================
// Snake.v generated from TopDesign.cysch
// 06/13/2020 at 17:50
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3e4d23fc-09d3-4a2d-8b8a-4e34e79fae6f/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    Timer_v2_80_2 Timer_Real (
        ...
        .tc(Net_37),
        .clock(Net_29));
    defparam Timer_Real.CaptureCount = 2;
    defparam Timer_Real.CaptureCounterEnabled = 0;
    defparam Timer_Real.DeviceFamily = "PSoC5";
    defparam Timer_Real.InterruptOnCapture = 0;
    defparam Timer_Real.InterruptOnTC = 1;
    defparam Timer_Real.Resolution = 16;
    defparam Timer_Real.SiliconRevision = "0";
    ...
    Timer_v2_80_3 Timer_Tic (
        ...
        .tc(Net_47),
        .clock(Net_29));
    defparam Timer_Tic.CaptureCount = 2;
    defparam Timer_Tic.CaptureCounterEnabled = 0;
    defparam Timer_Tic.DeviceFamily = "PSoC5";
    defparam Timer_Tic.InterruptOnCapture = 0;
    defparam Timer_Tic.InterruptOnTC = 1;
    defparam Timer_Tic.Resolution = 16;
    defparam Timer_Tic.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("ba8b1b3c-3e2e-433b-8bbe-4622546b829f"),
    ...
    Timer_v2_80_4 Timer_Seed (
        ...
        .tc(Net_58),
        .clock(Net_50));
    defparam Timer_Seed.CaptureCount = 2;
    defparam Timer_Seed.CaptureCounterEnabled = 0;
    defparam Timer_Seed.DeviceFamily = "PSoC5";
    defparam Timer_Seed.InterruptOnCapture = 0;
    defparam Timer_Seed.InterruptOnTC = 0;
    defparam Timer_Seed.Resolution = 16;
    defparam Timer_Seed.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Pause_net;
	wire [0:0] tmpFB_0__Pause_net;
	wire [0:0] tmpIO_0__Pause_net;
	electrical [0:0] tmpSIOVREF__Pause_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pause
		 (.oe(tmpOE__Pause_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pause_net[0:0]}),
		  .io({tmpIO_0__Pause_net[0:0]}),
		  .siovref(tmpSIOVREF__Pause_net),
		  .interrupt({Net_117}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pause_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Resume_net;
	wire [0:0] tmpFB_0__Resume_net;
	wire [0:0] tmpIO_0__Resume_net;
	electrical [0:0] tmpSIOVREF__Resume_net;

	cy_psoc3_pins_v1_10
		#(.id("a5a6bf4b-9ebf-4e77-aefb-5bafaa196212"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Resume
		 (.oe(tmpOE__Resume_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Resume_net[0:0]}),
		  .io({tmpIO_0__Resume_net[0:0]}),
		  .siovref(tmpSIOVREF__Resume_net),
		  .interrupt({Net_127}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Resume_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
