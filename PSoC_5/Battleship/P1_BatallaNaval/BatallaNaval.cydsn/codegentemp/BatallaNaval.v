// ======================================================================
// BatallaNaval.v generated from TopDesign.cysch
// 05/18/2020 at 04:05
...
// CharLCD_v2_20(ConversionRoutines=true, CUSTOM0="1F,1F,1F,1F,1F,1F,1F,1F,", CUSTOM1="0,0,E,E,E,E,0,0,", CUSTOM2="11,A,4,4,4,4,A,11,", CUSTOM3="C,19,13,6,C,19,13,6,", CUSTOM4="A,15,A,15,A,15,A,15,", CUSTOM5="0,0,1B,E,4,E,1B,0,", CUSTOM6="0,E,8,E,2,E,0,0,", CUSTOM7="0,4,4,4,0,4,0,0,", CustomCharacterSet=3, TypeReplacementString=uint8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONFIG_TITLE=LCD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LCD, )
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8002bc31-7527-467f-959d-e220f12e206b/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__BUT_net;
	wire [0:0] tmpFB_0__BUT_net;
	wire [0:0] tmpIO_0__BUT_net;
	wire [0:0] tmpINTERRUPT_0__BUT_net;
	electrical [0:0] tmpSIOVREF__BUT_net;
	...
	cy_psoc3_pins_v1_10
		...
		BUT
		 (.oe(tmpOE__BUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUT_net[0:0]}),
		  .io({tmpIO_0__BUT_net[0:0]}),
		  .siovref(tmpSIOVREF__BUT_net),
		  .interrupt({tmpINTERRUPT_0__BUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
