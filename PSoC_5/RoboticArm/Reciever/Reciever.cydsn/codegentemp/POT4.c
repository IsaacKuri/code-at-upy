...
{
    uint8 staticBits = (POT4_DR & (uint8)(~POT4_MASK));
    POT4_DR = staticBits | ((uint8)(value << POT4_SHIFT) & POT4_MASK);
}
...
{
	CyPins_SetPinDriveMode(POT4_0, mode);
}
...
{
    return (POT4_PS & POT4_MASK) >> POT4_SHIFT;
}
...
{
    return (POT4_DR & POT4_MASK) >> POT4_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(POT4_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & POT4_0_INTR) != 0u) 
		{ 
			 POT4_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (POT4_INTSTAT & POT4_MASK) >> POT4_SHIFT;
    }
