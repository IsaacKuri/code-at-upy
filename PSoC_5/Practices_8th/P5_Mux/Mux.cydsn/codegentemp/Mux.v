// ======================================================================
// Mux.v generated from TopDesign.cysch
// 05/27/2020 at 19:13
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_8 or Net_9 or Net_10 or Net_11 or Net_28)
        begin
            case (Net_28[1:0])
                2'b00 :  tmp__mux_1_reg = Net_8;
                2'b01 :  tmp__mux_1_reg = Net_9;
                2'b10 :  tmp__mux_1_reg = Net_10;
                2'b11 :  tmp__mux_1_reg = Net_11;
            endcase
        end
        assign Net_1 = tmp__mux_1_reg;
    end
    // -- Mux end --
	...
	cy_clock_v1_0
		#(.id("49a00210-ebc0-44e7-8059-b72fa37a675a"),
