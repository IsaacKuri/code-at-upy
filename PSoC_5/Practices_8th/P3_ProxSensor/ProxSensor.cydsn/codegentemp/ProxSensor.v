// ======================================================================
// ProxSensor.v generated from TopDesign.cysch
// 05/22/2020 at 18:58
...
module CapSense_CSD_v3_50_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("fbb6a05b-f26a-4041-80fb-516baba38e95/232398c5-3876-4e07-8f5b-7cd7657055e2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_port_v1_0
		#(.width(1),
		  .siorefwidth(1),
		  .id("fbb6a05b-f26a-4041-80fb-516baba38e95/dd9c1af8-be5a-4b9e-b10c-b2d9f11dc9fc"),
		  .pin_aliases({"ProximitySensor0","_0__PROX"}),
		  .access_mode("HW_ONLY"),
		  .layout_mode("NONCONTIGUOUS"),
		  .port_mode("ANALOG"),
		  .intr_mode(2'b00),
	...
	cy_clock_v1_0
		#(.id("fbb6a05b-f26a-4041-80fb-516baba38e95/0ad1a1a8-974e-43a0-841b-3af08590011d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("fbb6a05b-f26a-4041-80fb-516baba38e95/52b807b3-40a8-4a39-b1e7-e18f76c3b871"),
