// ======================================================================
// ClassManager.v generated from TopDesign.cysch
// 06/01/2020 at 02:09
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("82b5ba16-032a-462a-8739-42cde5087951"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("89a416e8-9f42-4d3d-a891-3078d73e64b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ListC_net;
	wire [0:0] tmpFB_0__ListC_net;
	wire [0:0] tmpIO_0__ListC_net;
	wire [0:0] tmpINTERRUPT_0__ListC_net;
	electrical [0:0] tmpSIOVREF__ListC_net;
	...
	cy_psoc3_pins_v1_10
		...
		ListC
		 (.oe(tmpOE__ListC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ListC_net[0:0]}),
		  .io({tmpIO_0__ListC_net[0:0]}),
		  .siovref(tmpSIOVREF__ListC_net),
		  .interrupt({tmpINTERRUPT_0__ListC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ListC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
