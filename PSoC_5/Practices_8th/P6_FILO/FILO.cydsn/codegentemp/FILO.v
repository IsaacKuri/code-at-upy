// ======================================================================
// FILO.v generated from TopDesign.cysch
// 05/27/2020 at 21:38
...
module top ;
    ...
    assign Net_96 = Net_144[2] | Net_144[1] | Net_144[0];
	...
	cy_psoc3_pins_v1_10
		#(.id("7e7d9a92-05ff-407b-aaed-326cdf1e7736"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("831c38db-a4dd-43da-a212-dd99c967d60e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("77aec5ac-b06d-4fa6-ad8d-b0fd64249911"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_109 = Net_144[1] & AN;


    assign Net_110 = Net_144[1] & CN;


    assign Net_112 = Net_144[2] & BN;


    assign Net_111 = Net_109 | Net_110 | Net_112;


    assign Net_120 = Net_144[2] & BN;


    assign Net_121 = AN & Net_144[1] & Net_144[0];


    assign Net_122 = Net_120 | Net_121;


    assign Net_126 = Net_144[2] & BN & CN;
