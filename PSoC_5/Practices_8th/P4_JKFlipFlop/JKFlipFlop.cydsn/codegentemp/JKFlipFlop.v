// ======================================================================
// JKFlipFlop.v generated from TopDesign.cysch
// 05/25/2020 at 21:26
...
module top ;
    ...
    assign Net_226 = ~(Net_224 | Net_245);


    assign Net_228 = Net_219 & Net_245;


    assign Net_224 = Net_226 & Net_219;


    assign Net_245 = ~(Net_226 | Net_228);


    assign Net_236 = ~(Net_226 & Net_219);


    assign Net_240 = ~(Net_219 & Net_234);


    assign Net_2 = ~(Net_236 & Net_241);


    assign Net_241 = ~(Net_2 & Net_240);


    assign Net_234 = ~Net_226;
	...
	cy_psoc3_pins_v1_10
		#(.id("92bb21fb-b909-4550-936c-58d12abef015"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
